...
$titulo = $_POST['tituloEditar']; //Vem do arquivo decisao-editarPostagem
 ...
 $img = $_FILE['imgEditar']; //Vem do arquivo decisao-editarPostagem
...
$stmt = $conexao -> prepare ("update tbPostagem inner join tbPrestadorServico on tbPostagem.codPrestadorServico = tbPrestadorServico.codPrestadorServico
                             set descricaoPostagem='$descricao', imgPostagem='$img', tituloPostagem='$titulo', dataPostagem='$data' tbPrestadorServico.codPrestadorServico='$cod' where tbPrestadorServico.emailPrestadorServico like '%$_SESSION[email]%'");
$stmt -> execute();
