...
<?php /*
    ...
    <main>
        <div class="login-container2" id="login-container2">
            ...
            <form class="form form-login" action="EditarPostagem.php" enctype="multipart/form-data" method="POST">
        ...
        ?>
            ...
            <input class="form-input"  type="select" name="imgEditar" value="<?php if(isset($row_msg_cont['imgPostagem'])){ echo $row_msg_cont['imgPostagem']; } ?>">  
