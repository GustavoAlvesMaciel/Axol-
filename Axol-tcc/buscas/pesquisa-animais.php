...
try {
  ...
  $codAnimais = $_POST['codAnimais'];

  $pesquisaAnimais = $animais->pesquisaAnimais($codAnimais);
} catch (Exception $e) {
  echo $e->getMessage();
}
...
<br>
          ...
          <form class="d-flex" role="search" action="../buscas/pesquisa-animais.php" method="post">
            <input class="form-control me-2" type="search" placeholder="Pesquisar" aria-label="Search" name="codAnimais" id="codAnimais">
    ...
    <thead>
            ...
            <tbody>
              <?php foreach ($pesquisaAnimais as $pesquisa) { ?>
                <tr>

                 <td><?php echo $codAnimais = $pesquisa['codAnimais'] ?></td>
                  ...
                  <form action="../restrito/decisao-editarAnimais.php" method="post">
                    <td><button type="submit" class="btn btn-secondary" name="linha" id="linha" value="<?php echo $codAnimais ?>">Editar</button></td>
                  </form>

                  <!--excluir-->
                  <form action="../restrito/decisao-excluirAnimais.php" method="post">
                    <td><button type="submit" class="btn btn-danger" name="linha" id="linha" value="<?php echo $codAnimais ?>">Excluir</button></td>
                  </form>
