            ...
            <tbody>
              <?php foreach ($pesquisaEspecialidade as $pesquisa) { ?>
                <tr>
                  ...
                  <form action="../restrito/decisao-editarEspecialidade.php" method="post">
                    <td><button type="submit" class="btn btn-secondary" name="linha" id="linha" value="<?php echo $codEspecialidade ?>">Editar</button></td>
                  </form>

                  <!--excluir-->
                  <form action="../restrito/decisao-excluirEspecialidade.php" method="post">
                    <td><button type="submit" class="btn btn-danger" name="linha" id="linha" value="<?php echo $codEspecialidade ?>">Excluir</button></td>
                  </form>
