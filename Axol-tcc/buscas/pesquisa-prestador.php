            ...
            <tbody>
              <?php foreach ($pesquisaPrestador as $pesquisa) { ?>
                <tr>
                  ...
                  <form action="../restrito/decisao-editarPrestador.php" method="post">
                    <td><button type="submit" class="btn btn-secondary" name="linha" id="linha" value="<?php echo $codPrestadorServico ?>">Editar</button></td>
                  </form>

                  <!--excluir-->
                  <form action="../restrito/decisao-excluirPrestador.php" method="post">
                    <td><button type="submit" class="btn btn-danger" name="linha" id="linha" value="<?php echo $codPrestadorServico ?>">Excluir</button></td>
                  </form>
